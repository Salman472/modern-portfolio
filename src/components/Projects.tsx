...
const projects = [
  {
    ...
    details:
      "This dashboard provides detailed analytics with charts, reports, and user statistics.",
    liveUrl: "#",
    githubUrl: "#",
  },
  {
    ...
    details:
      "An advanced e-commerce platform with payment gateway, product management and admin dashboard.",
    liveUrl: "#",
    githubUrl: "#",
  },
  {
    ...
    description: "Social media platform with messaging.",
    details:
      "Users can create profiles, share posts and chat in real-time with friends.",
    liveUrl: "#",
    githubUrl: "#",
  },
  {
    ...
    details:
      "A modern portfolio template with animation, responsive layout and project showcase.",
    liveUrl: "#",
    githubUrl: "#",
  },
  {
    ...
    hoverImage: project3,
    tech: ["React", "API"],
    description: "Weather app with forecasts.",
    details:
      "Weather application showing real-time weather data with forecast and location search.",
    liveUrl: "#",
    githubUrl: "#",
  },
];
